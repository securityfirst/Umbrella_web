        ...
        <Paper className={classes.modalContent} elevation={1}>
          ...
          <div className={classes.panelsWrapper}>
            <Typography className={classes.modalContentTitle}>
              {systemLocaleMap[locale].pathways_title}
            </Typography>
            <Typography className={classes.modalContentDescription}>
              {systemLocaleMap[locale].pathways_text}
            </Typography>
          ...
          <Typography
            ...
            onClick={this.handleDismiss}
          >
            {systemLocaleMap[locale].pathways_no_thanks_button}
          </Typography>
        </Paper>
      </Dialog>
    );
...
export default withRouter(
  connect(mapStateToProps)(
    withStyles(styles, { withTheme: true })(PathwayModal)
  )
);
