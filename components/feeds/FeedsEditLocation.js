...
class FeedsEditLocation extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    if (!location)
      return dispatch(
        openAlert("error", systemLocaleMap[locale].feed_location_label)
      );
  ...
  render() {
    ...
    return (
      <IconModalContent
        icon={
          <PersonPinCircleIcon
            classes={{ fontSizeLarge: classes.iconFontSize }}
            fontSize="large"
            color="primary"
          />
        }
...
export default connect(mapStateToProps)(
  withStyles(styles, { withTheme: true })(FeedsEditLocation)
);
