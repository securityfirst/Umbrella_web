...
export const pathwaysTypes = {
  GET_PATHWAY_FILE: "GET_PATHWAY_FILE",
  UPDATE_PATHWAYS_CHECKED: "UPDATE_PATHWAYS_CHECKED",
  GET_PATHWAYS_SAVED: "GET_PATHWAYS_SAVED",
  UPDATE_PATHWAYS_SAVED: "UPDATE_PATHWAYS_SAVED",
  SYNC_PATHWAYS: "SYNC_PATHWAYS",
  CLEAR_PATHWAYS_SAVED: "CLEAR_PATHWAYS_SAVED",
};
...
export const viewTypes = {
  ...
  TOGGLE_PATHWAY_MODAL: "TOGGLE_PATHWAY_MODAL",
  DISMISS_PATHWAY_MODAL: "DISMISS_PATHWAY_MODAL",
  SYNC_PATHWAY: "SYNC_PATHWAY",
  SET_LOCALE: "SET_LOCALE",
  GET_CONTENT_LOCALE_MAP: "GET_CONTENT_LOCALE_MAP",
  GET_SYSTEM_LOCALE_MAP: "GET_SYSTEM_LOCALE_MAP",
