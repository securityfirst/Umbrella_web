...
class Checklists extends React.Component {
  ...
  render() {
    ...
    return (
      <Layout
        title={`${systemLocaleMap[locale].app_name} | ${systemLocaleMap[locale].checklist_title}`}
      ...
      >
        ...
        {tabIndex === 1 ? <ChecklistsCustom /> : <ChecklistsSystem />}
      </Layout>
    );
  }
}
...
export default connect(mapStateToProps)(
  withStyles(styles, { withTheme: true })(Checklists)
);
