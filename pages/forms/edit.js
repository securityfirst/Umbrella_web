...
class FormsEdit extends React.Component {
	render() {
		...
		return (
			<Layout title="Umbrella | Forms - Edit" description="Umbrella web application">
				<div className={classes.content}>
					<Typography variant="h6">Forms Edit</Typography>
...
export default withStyles(styles, {withTheme: true})(FormsEdit);