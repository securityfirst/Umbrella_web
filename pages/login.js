...
class Login extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.locale !== this.props.locale) {
      this.props.dispatch(
        setAppbarTitle(
          nextProps.systemLocaleMap[nextProps.locale].login_message_button
        )
      );
    }
  }
  ...
  render() {
    ...
    return (
      <Layout
        title={`${systemLocaleMap[locale].app_name} | ${systemLocaleMap[locale].login_message_button}`}
        ...
        <div className={classes.content}>
          <Paper className={classes.paper} elevation={1}>
            ...
            <Typography
              ...
              align="center"
            >
              {systemLocaleMap[locale].login_your_password}
            </Typography>
...
export default withRouter(
  connect(mapStateToProps)(withStyles(styles, { withTheme: true })(Login))
);
