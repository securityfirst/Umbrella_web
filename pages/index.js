...
class Index extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.locale !== this.props.locale) {
      this.props.dispatch(
        setAppbarTitle(nextProps.systemLocaleMap[nextProps.locale].app_name)
      );
    }
  }
  ...
  render() {
    ...
    return (
      <Layout
        title={systemLocaleMap[locale].app_name}
          ...
          <Paper className={classes.paper} elevation={1}>
            <div className={classes.headerWrapper}>
              <img
                ...
                src="/static/assets/images/umbrella_logo.png"
                alt="Umbrella logo"
              />
              <Typography className={classes.header} variant="h1">
                {systemLocaleMap[locale].welcome_to_umbrella}
              </Typography>
            </div>
            ...
            <Typography paragraph>
              {systemLocaleMap[locale].welcome_paragraph_two}{" "}
              <a href="mailto:info@secfirst.org" target="_blank">
                info@secfirst.org
              </a>
              .
            </Typography>
            ...
            <Typography className={classes.title} variant="h2">
              {systemLocaleMap[locale].welcome_subtitle_one}
            </Typography>
            <Typography component="div">
              <ul className={classes.list}>
                ...
                <li>
                  {systemLocaleMap[locale].welcome_listitem_eight}{" "}
                  <a href="mailto:feedback@secfirst.org" target="_blank">
                    feedback@secfirst.org
                  </a>
                </li>
              </ul>
            </Typography>
            ...
            <Typography className={classes.title} variant="h2">
              {systemLocaleMap[locale].welcome_subtitle_two}
            </Typography>
            <Typography component="div">
              <ul className={classes.list}>
            ...
            <Typography variant="caption" paragraph>
              {systemLocaleMap[locale].welcome_paragraph_three}{" "}
              <a href="https://github.com/securityfirst" target="_blank">
            ...
            <Typography
              ...
              paragraph
            >
              {systemLocaleMap[locale].terms_conditions}:{" "}
              <a href="https://secfirst.org/terms/" target="_blank">
                https://secfirst.org/terms/
              </a>
            </Typography>
            ...
            <Typography
              ...
              paragraph
            >
              {systemLocaleMap[locale].welcome_privacy_title}:{" "}
              <a href="https://secfirst.org/privacy/" target="_blank">
                https://secfirst.org/privacy/
              </a>
            </Typography>
          </Paper>
        </div>
